      ...
      <div className="flex justify-between mb-5 border-b border-gray-200">
        {!roles?.includes("student") && (
          <h4
            ...
            className={`${active === 1 && "border-b-[2px] border-[#232D42]"} cursor-pointer font-nunito`}
          >
            Private
          </h4>
        )}
        <h4
          ...
          className={`${active === 2 && "border-b-[2px] border-[#232D42]"} cursor-pointer font-nunito`}
        >
          Groups
        </h4>
      </div>
          ...
          {!roles?.includes("student") && active === 1 && (
            <div>
              {isLoading ? (
                ...
                socketUser
                  .sort((a: any, b: any) => {
                    (console.log(b), a.createdAt - b.createdAt);
                  })
                  .map((val: any) => (
                    <SingleUser
