...
const ActionConfirmModal = (props: Props) => {
  ...
  const [DeleteAssignment, { isError, error, isLoading, isSuccess }] =
      ...
      <Modal.Body>
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <Button color={sureButtonColor} onClick={actionHandler}>
              {isLoading ? <ButtonLoader /> : "Yes, I'm sure"}
            </Button>
            <Button color={cancelButtonColor} onClick={handleClose}>
              No, cancel
            </Button>
          </div>
        </div>
