...
const MentoringViewModal = ({
  ...
  const { data, isSuccess, isError, isLoading } = useGetOneMentoringQuery(id);
  //  console.log(id);
  const [
    updateMentoring,
    {
                    ...
                    <form onSubmit={handleSubmit(UpdateUserData)}>
                      <div className="form_control mb-5">
                        ...
                        <input
                          ...
                          defaultValue={data.data.mentoring.firstName}
                      ...
                      <div className="form_control mb-5">
                        ...
                        <input
                          ...
                          defaultValue={data.data.mentoring.email}
                      ...
                      <div className="form_control mb-5">
                        ...
                        <input
                          ...
                          defaultValue={data.data.mentoring.interest}
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          type="submit"
                          className="w-[60px] h-[40px] flex justify-center items-center text-white  bg-[#3A57E8] "
                        >
                          {updateMentoringLoading ? (
                            <div>
                              <Spinner />
                            </div>
                          ) : (
...
export default MentoringViewModal;
