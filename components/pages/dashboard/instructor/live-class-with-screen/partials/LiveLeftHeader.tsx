...
const LiveLeftHeader = () => {
  ...
  return (
    <div className="py-4 pl-5 lg:pl-10 pr-3 bg-white shadow flex justify-between items-center font-nunito">
      {/* <Link href="/dashboard"> */}
      ...
      {/* </Link> */}
      <div>
        <p className="text-[16px] lg:text-[28px] font-bold text-[#232D42] font-nunito">
          Topic of Lecture...
        </p>
      </div>
