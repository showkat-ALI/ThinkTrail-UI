...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-sm bg-white border-b border-slate-800/30">
                ...
                <Fragment key={idx}>
                  {menuItem.submenus ? (
                    ...
                    <Link 
                      ...
                      className="text-sm font-medium text-black-50 hover:text-emerald-400 transition-colors duration-200"
                    >
                      {menuItem.name}
                    </Link>
                  )}
