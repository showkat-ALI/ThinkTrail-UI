...
const index = () => {
  return (
    <>
      <Head>
        <title>terms-of-use | Fourth IT Academy</title>
      </Head>
      <HomeLayout>
            ...
            <div className="xl:w-[50%] md:w-[50%] lg:w-[50%] sm:w-[50%] xsm:w-[100%]">
              <div>
                ...
                <p className="my-[50px]">
                  ...
                  (“you”) and Fourth IT Academy , doing business as Fourth IT
                  Academy (&quot;
                  <span className="font-extrabold">Fourth IT Academy </span>
                  &quot;, &quot;
                  ...
                  fourthacademy.com website as well as any other media form,
                ...
                <p>
                  ...
                  each such changes. Please ensure that you check the applicable
              ...
              <div>
                <h1 className="font-extrabold my-[50px]">
              ...
              <div>
                ...
                <p className="mb-[36px]">
                  ...
                  you have received parental permission to use the Site; (5) you
                ...
                <div className="mt-[20px]">
                  ...
                  <ul>
                    ...
                    <li className="my-[10px]">
                      ...
                      as using scripts to send comments or messages, or using
                    ...
                    <li className="my-[10px]">
                      ...
                      with us or otherwise use the Site and/or the Content for
              ...
              <div>
                ...
                <ul className="my-[20px]">
                  ...
                  <li className="my-[10px]">
                    &#x2022; Your Your Contributions do not violate any
                  ...
                  <li className="my-[10px]">
                    ...
                    link to material that violates, any provision of these Terms
              ...
              <div>
                <h1 className="font-extrabold my-[50px]">9. SOCIAL MEDIA</h1>
                <p className="">
              ...
              <div>
                <h1 className="font-extrabold my-[50px]">10. SUBMISSIONS</h1>
                <p>
              ...
              <div>
                ...
                <p>
                  ...
                  or contained in the Third-Party Websites or the Third-Party
                  ...
                  so at your own risk, and you should be aware these Terms of
                  Use no longer govern. You should review the applicable terms
                  and policies, including privacy and data gathering practices,
                  of any website to which you navigate from the Site or relating
                  ...
                  harmless from any losses sustained by you or harm caused to
                  you relating to or resulting in any way from any Third-Party
                  Content or any contact with Third-Party Websites.
                </p>
              </div>
              <div>
                <h1 className="font-extrabold my-[50px]">12. ADVERTISERS</h1>
                <p>
              ...
              <div>
                <h1 className="font-extrabold my-[50px]">14. PRIVACY POLICY</h1>
                <p>
              ...
              <div>
                ...
                <p>
                  ...
                  courts located in hereby consent to, and waive all defenses of
                  ...
                  Site be commenced more than one (1) years after the cause of
                  action arose.
                </p>
              </div>
              <div>
                <h1 className="font-extrabold my-[50px]">19. CORRECTIONS</h1>
                <p>
              ...
              <div>
                <h1 className="font-extrabold my-[50px]">20. DISCLAIMER</h1>
                <p>
              ...
              <div>
                ...
                <p>
                  ...
                  LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $500.00
              ...
              <div>
                <h1 className="font-extrabold my-[50px]">23. USER DATA</h1>
                <p>
              ...
              <div>
                <h1 className="font-extrabold my-[50px]">26. MISCELLANEOUS</h1>
                <p>
              ...
              <div>
                <h1 className="font-extrabold my-[50px]">27. CONTACT US</h1>
                <p>
              ...
              <div className="my-[50px]">
                <h1 className="font-extrabold  ">The Fourth IT Academy </h1>
                <h1 className="font-extrabold my-[20px]">__________</h1>
                <h1 className="font-extrabold ">United States</h1>
                <h1 className="font-extrabold mt-[20px]">
                  info@ fourthacademy.com
                </h1>
              </div>
            </div>
          </div>
